...
const cartItems: CartItemsType = [
  {
     ...
     shortDescription:
      "Lorem ipsum dolor sit amet consect adipisicing elit lorem ipsum dolor sit.",     description:
...
colors: ["gray", "green"],
   ...
   },
  {
    ...
    images: {
       green: "/products/3gr.png",       blue: "/products/3b.png",
...
const Cart = () => {
    ...
    const [shippingForm, setShippingForm] = useState<ShippingFormInputs | paymentFormInputs>()
